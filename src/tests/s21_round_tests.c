...
TCase *s21_round_get_tests(void) {
  ...
  tcase_add_test(test_cases, test_round_1);
  tcase_add_test(test_cases, test_round_2);
  tcase_add_test(test_cases, test_round_3);
  tcase_add_test(test_cases, test_round_4);
  tcase_add_test(test_cases, test_round_5);
  return test_cases;
}
