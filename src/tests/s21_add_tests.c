...
Suite *s21_add_tests(void) {
  Suite *s = suite_create("\033[1;35ms21_add\033[0m\n");
  TCase *testCase = tcase_create("s21_test_add");

  suite_add_tcase(s, testCase);
  // tcase_add_test(testCase, test_s21_add);
  tcase_add_test(testCase, test_s21_add_simple);
  tcase_add_test(testCase, test_s21_add_with_scale);
  tcase_add_test(testCase, test_s21_add_with_diff_scale);
  tcase_add_test(testCase, test_s21_add_check_boards_mantissa_1);
  tcase_add_test(testCase, test_s21_add_check_boards_mantissa_2);
  tcase_add_test(testCase, test_s21_add_negative_numbers);
  tcase_add_test(testCase, test_s21_add_negative_first_num_1);
  tcase_add_test(testCase, test_s21_add_negative_first_num_2);
  tcase_add_test(testCase, test_s21_add_negative_second_num_1);
  tcase_add_test(testCase, test_s21_add_negative_second_num_2);
  tcase_add_test(testCase, test_s21_add_with_zero);
  tcase_add_test(testCase, test_s21_add_large_numbers);
  ...
  tcase_add_test(testCase, case_NULL_result);
  tcase_add_test(testCase, case_0_add_0);
  tcase_add_test(testCase, case_0_add_minus_0);
  tcase_add_test(testCase, case_minus_0_add_0);
  tcase_add_test(testCase, case_MAX_add_04);
  tcase_add_test(testCase, case_MIN_add_minus_0_6);
  tcase_add_test(testCase, case_MIN_add_minus_0_5);
  tcase_add_test(testCase, case_MIN_add_minus_0_4);
  tcase_add_test(testCase, case_MAX_add_06);
  tcase_add_test(testCase, case_MAX_add_05);
  tcase_add_test(testCase, case_MAX_add_minus_0_6);
  tcase_add_test(testCase, case_MIN_add_0_6);
  tcase_add_test(testCase, case_1e_28_add_1e_28);
  tcase_add_test(testCase, case_minus_1e_28_add_1e_28);
  tcase_add_test(testCase, case_1e_28_add_minus_1e_28);
  tcase_add_test(testCase, case_1e_28_add_123);
  tcase_add_test(testCase, case_MAX_add_1e_28);
  tcase_add_test(testCase, case_MIN_add_5e_28);
  tcase_add_test(testCase, case_1234567890_add_1234567890);
  tcase_add_test(testCase, case_minus_1234567890_add_minus_1234567890);
  tcase_add_test(testCase, case_minus_1234567890_add_1234567890);
  tcase_add_test(testCase, case_1234567890_add_minus_1234567890);
  tcase_add_test(testCase, case_123_4567890_add_123_4567890);
  tcase_add_test(testCase, case_1234567890_add_123_4567890);
  tcase_add_test(testCase, case_minus_1234567890_add_123_4567890);
  tcase_add_test(testCase, case_1234567890_add_minus_123_4567890);
  tcase_add_test(testCase, case_minus_123_4567890_add_minus_1234567890);
  tcase_add_test(testCase, case_minus_1234567890_add_minus_123_4567890);
  tcase_add_test(testCase, case_123_4567890_add_1234567890);
  tcase_add_test(testCase, case_0_005_add_0_555);
  tcase_add_test(testCase, case_minus_0_005_add_0_555);
  tcase_add_test(testCase, case_0_005_add_minus_0_555);
  tcase_add_test(testCase, case_minus_0_005_add_minus_0_555);
  tcase_add_test(testCase, case_0_9_9_add_0_0_1);
  tcase_add_test(testCase, case_MAX_add_0);
  tcase_add_test(testCase, case_0_add_MAX);
  tcase_add_test(testCase, case_MIN_add_0);
  tcase_add_test(testCase, case_0_add_MIN);
  tcase_add_test(testCase, case_MIN_add_MAX);
  tcase_add_test(testCase, case_MAX_add_MAX);
  tcase_add_test(testCase, case_MAX_add_1);
  tcase_add_test(testCase, case_MIN_add_MIN);
  tcase_add_test(testCase, case_MIN_add_minus_1);
  tcase_add_test(testCase, case_MAX_add_MIN);
