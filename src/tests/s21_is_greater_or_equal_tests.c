...
START_TEST(test_1) {
  ...
  int comparison = s21_is_greater_or_equal(value_1, value_2);
...
Suite *s21_is_greater_or_equal_tests(void) {
  Suite *s = suite_create("\033[1;35ms21_is_greater_or_equal\033[0m\n");
  TCase *testCase = tcase_create("s21_test_is_greater_or_equal");
