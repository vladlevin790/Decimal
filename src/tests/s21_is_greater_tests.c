...
START_TEST(test_1) {
  ...
  int comparison = s21_is_greater(value_1, value_2);
...
START_TEST(test_7) {
  // 1 = 0.00000; 2 = -35.9439
  s21_decimal value_1 = {{0x87000000, 0x00000000, 0x00000000, 0x00000500}};
...
Suite *s21_is_greater_tests(void) {
  Suite *s = suite_create("\033[1;35ms21_is_greater\033[0m\n");
  TCase *testCase = tcase_create("s21_test_case_is_greater");
